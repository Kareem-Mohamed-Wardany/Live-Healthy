...
class ResNetModel:
    ...
    def init_model(self):
        ...
        # Get model base
        inputs, outputs = self.model_base((config.get("width"), config.get("height"),\
            config.get("dim")))
